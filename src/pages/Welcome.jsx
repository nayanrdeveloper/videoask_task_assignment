  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center mx-auto space-y-4">
        <WelcomeButton btnText="Campaign structure" btnIndex="A" routePath="campaignPage" />
        <WelcomeButton btnText="Learn Facebook basics" btnIndex="B" routePath="webinarPage" />
        <WelcomeButton btnText="3rd choice" btnIndex="C" routePath="thirdChoicePage" />
      </div>
    </div>
  );
}
